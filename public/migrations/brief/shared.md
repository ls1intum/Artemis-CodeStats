# Artemis client migration brief: shared
...
- `src/main/webapp/app/shared/deimos/deimos-date-range-modal.component.html` — 12 hits
  - `d-flex`×4 → flex
...
- `src/main/webapp/app/shared/components/unified-feedback/unified-feedback.component.html` — 30 hits
  - `alert`×1 → tum-ui-message
  - PrimeNG: pTooltip → tumUiTooltip
  - `src/main/webapp/app/shared/components/unified-feedback/unified-feedback.component.scss`: 29 --bs-* variables
